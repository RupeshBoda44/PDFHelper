...
public class PdfHelperCore {
    private static final String TAG = PdfHelperCore.class.getName();
    ...
    public PdfHelperCore(Context ctx) {
     ...
     * Page must be opened before rendering.
     * <p>
     * For more info see {@link PdfHelperCore#renderPageBitmap(PdfDocument, Bitmap, int, int, int, int, int)}
     */
    public void renderPageBitmap(PdfDocument doc, Bitmap bitmap, int pageIndex,
                                 int startX, int startY, int drawSizeX, int drawSizeY,
                                 boolean renderAnnot) {
    ...
    /**
     * @return mapped coordinates
     * @see PdfHelperCore#mapPageCoordsToDevice(PdfDocument, int, int, int, int, int, int, double, double)
     */
